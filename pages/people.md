...
<h2>Core members</h2>
{% assign pi = site.data.people.core | where: 'program', 'Faculty PI' %}
{% assign others = site.data.people.core | where_exp: 'p', 'p.program != "Faculty PI"' %}
...
{% for group in site.data.people.intern_groups %}
...
{% for column in site.data.people.coursework_columns %}
