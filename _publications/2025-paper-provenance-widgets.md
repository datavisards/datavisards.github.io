...
year: 2025
month: 1
image: /assets/images/publications/2025-provenance-widgets.png
type: Journal
tags:
  - "Guidance & Analytic Provenance"
recognitions:
  - label: GRSI Replicability Stamp
    url: https://www.replicabilitystamp.org/#https-github-com-provenancewidgets-provenancewidgets-github-io
doi: https://doi.org/10.1109/TVCG.2024.3456144
pdf: /assets/pdfs/publications/2025-paper-provenance-widgets.pdf
abstract: >-
...
links:
  video:
    - url: https://youtu.be/7l6jKbS2SFI
  talk:
    - label: Recorded
      url: https://youtu.be/fHks4OlE2qY
    - label: Live
      url: https://youtu.be/HC69aABUJuc?t=3748
  slides:
    - url: /assets/pdfs/slides/2025-slides-provenance-widgets.pdf
  demo:
    - url: https://provenancewidgets.github.io/showcase/#/playground
  code:
    - url: https://github.com/ProvenanceWidgets/ProvenanceWidgets/tree/v1
  npm:
